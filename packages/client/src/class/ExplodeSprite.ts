import { EExplodeDir, EXPODER_DIRS } from "@ob/shared/types";
import { plus, points } from "@ob/core/point";
...
class BlockSprite extends Frame {
  ...
  update(dtime: number, time: number): void {
    ...
    const frame = clamp(((time - this.startAnimate) / this.speed | 0), 0, size - 1);
