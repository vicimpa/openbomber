import { DEATH_FRAMES, EAnimate, EDir, EEffect, EMapItem, ESounds } from "@ob/shared/types";
import {
  MESSAGE_LENGTH,
  NICK_LENGTH,
  PLAYER_TIMEOUT,
  ...
  TIMEOUT_RECONNECT,
  TIMEOUT_SKIN
} from "@ob/shared/config";
import { gameApi, playerApi } from "@ob/shared/api";
import { getTime, setTime } from "../data/addressTime";
import { random, rem, round } from "@vicimpa/math";
