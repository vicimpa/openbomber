import { EMapItem, ESounds } from "@ob/shared/types";
import { MAX_PLAYERS, WAIT_FOR_LIMIT, ZONELIMIT_TIMEOUT } from "@ob/shared/config";
...
import { calcMap } from "@ob/core/calcMap";
